...
namespace PacificProject.Controllers
{
    public class DestinationsController : Controller
    {
        ...
        public DestinationsController(PacificContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("DestinationId,Country,Place,Tour,CountryImage,PlaceImage,Price,TourDayCount")] Destination destination)
        {
